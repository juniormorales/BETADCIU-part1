...
idle_xml_name = 'InfernoM POV idle'
left_xml_name = 'InfernoM POV left'
down_xml_name = 'InfernoM POV down'
up_xml_name = 'InfernoM POV up'
right_xml_name = 'InfernoM POV right'
...
name_of_character_xml = 'InfernoM POV'
name_of_character = 'mario'
