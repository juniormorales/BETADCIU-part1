...
function onEvent(name, value1, value2)
	...
	if name == "QT alert" then
		...
		if value1 == 'three' then
			setProperty("warn.alpha", 1)
			objectPlayAnimation('warn', 'three', true)
		end

		if value1 == 'four' then
			setProperty("warn.alpha", 1)
			objectPlayAnimation('warn', 'four', true)
		end
	end
end
...
function onUpdatePost()
	if getPropertyFromClass('flixel.FlxG',"keys.pressed.SPACE") then
		if dodging == false then
			...
			characterPlayAnim('girlfriend', 'dodge', true);
